...
{
    public class SafeTransactionRepo : Repository<SafeTransaction>,ISafeTransactionRepo
    {
        public SafeTransactionRepo(SmartStoreContext smartStoreContext ) :base(smartStoreContext)
        {
