...
{
    public class StoreItemQuantityRepo : Repository<StoreItemQuantity>,IStoreItemQuantityRepo
    {
        public StoreItemQuantityRepo(SmartStoreContext smartStoreContext):base(smartStoreContext)
        {
